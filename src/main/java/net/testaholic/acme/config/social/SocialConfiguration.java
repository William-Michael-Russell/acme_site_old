package net.testaholic.acme.config.social;

import net.testaholic.acme.repository.SocialUserConnectionRepository;
import net.testaholic.acme.repository.CustomSocialUsersConnectionRepository;
import net.testaholic.acme.security.social.CustomSignInAdapter;
